#test for option 1
from src.programA import decimal_to_hex_16bit #importing the conver function from the main program to test it

def test_convert(): #testing a decimal conversion
    hex_val, bin_val, signed = decimal_to_hex_16bit(10) #convert 10
    assert hex_val == "000A" #check the hexadecimal value is correct
...
def test_convert_signed(): #testing 16-bit signed conversion
    hex_val, bin_val, signed = decimal_to_hex_16bit(65535) #convert 65535 (maximum bit value)
...
def test_binary_length(): #testing the binary output is always 16 bits long
    hex_val, bin_val, signed = decimal_to_hex_16bit(5) #convert 5
...
def test_signed_32768(): #testing the signed value of 32768 (first value that is negative in 16-bit signed)
    hex_val, bin_val, signed = decimal_to_hex_16bit(32768) #convert 32768
